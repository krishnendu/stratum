...
pub const COMMANDS: &[Command] = &[
    ...
    Command { name: "mic", help: "Toggle push-to-talk mic capture (also F5). Stops, transcribes, attaches to next turn." },
    ...
    Command { name: "tts", help: "Toggle Piper TTS playback of replies. Usage: /tts [on|off]." },
